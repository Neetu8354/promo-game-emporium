...
const pages = {
  ...
  "app-download": {
    title: "Lotus365 App Download Help | Mobile Login Support",
    description: "Lotus365 app download and mobile access help for Android, iPhone, mobile login, account setup, withdrawal status, and WhatsApp guidance.",
    canonical: `${siteUrl}/app-download`,
    eyebrow: "Mobile App Help",
    heading: "Lotus365 App Download and Mobile Access",
    text: "Get quick help with mobile login, app download guidance, account setup, deposit confirmation, withdrawal status, KYC support, and bonus details.",
    image: whatsappScreen,
    imageAlt: "Download the Lotus365 mobile app and place bets on live cricket from your phone",
  },
  "about-us": {
